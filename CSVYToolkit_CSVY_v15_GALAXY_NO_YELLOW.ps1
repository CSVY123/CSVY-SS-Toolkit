...
$installDir = "$env:USERPROFILE\Downloads\CSVY Toolkit"
...
$ToolData = @(
    ...
    # CSVY collection - exact order requested
    @{ Name="Fileless";              Desc="Detects fileless activity via event logs and memory analysis"; Category="CSVY"; Type="GitHub"; URL="https://github.com/Orbdiff/Fileless/releases/latest" },
    @{ Name="MeowResolver";          Desc="Resolves obfuscated strings in binaries";      Category="CSVY"; Type="GitHub"; URL="https://github.com/MeowTonynoh/MeowResolver/releases/latest" },
    @{ Name="MeowClientsFucker";     Desc="Detects known cheat client artefacts";         Category="CSVY"; Type="GitHub"; URL="https://github.com/MeowTonynoh/MeowClientFucker/releases/latest" },
    @{ Name="BAMReveal";             Desc="Parses BAM forensic artefact";                 Category="CSVY"; Type="GitHub"; URL="https://github.com/Orbdiff/BAMReveal/releases/latest" },
    @{ Name="PrefetchView";          Desc="Parses prefetch, extracts file info";          Category="CSVY"; Type="GitHub"; URL="https://github.com/Orbdiff/PrefetchView/releases/latest" },
    @{ Name="UserAssistView";        Desc="Parses UserAssist registry artifact";          Category="CSVY"; Type="GitHub"; URL="https://github.com/Orbdiff/UserAssistView/releases/latest" },
    @{ Name="InjGen";                Desc="Detects JNI/JVMTI memory injections";         Category="CSVY"; Type="GitHub"; URL="https://github.com/Orbdiff/InjGen/releases/latest" },
    @{ Name="JournalTrace";          Desc="Traces file activity via USN journal";         Category="CSVY"; Type="GitHub"; URL="https://github.com/spokwn/JournalTrace/releases/latest" },
    @{ Name="MeowDoomsdayFucker";    Desc="Detects Doomsday cheat artefacts";             Category="CSVY"; Type="GitHub"; URL="https://github.com/MeowTonynoh/MeowDoomsdayFucker/releases/latest" },
    @{ Name="MeowModAnalyzer";       Desc="Analyzes mod files for suspicious content";    Category="CSVY"; Type="Cmd";    Command="Invoke-Expression (Invoke-RestMethod 'https://raw.githubusercontent.com/MeowTonynoh/MeowModAnalyzer/main/MeowModAnalyzer.ps1')" },
    @{ Name="Services";              Desc="Lists and analyzes running services";          Category="CSVY"; Type="Cmd";    Command="Invoke-Expression (Invoke-RestMethod 'https://raw.githubusercontent.com/praiselily/lilith-ps/refs/heads/main/Services.ps1')" },
    @{ Name="RL ModAnalyzer";        Desc="Analyzes mod files for cheat indicators";     Category="CSVY"; Type="GitHub"; URL="https://github.com/ItzIceHere/RedLotus-Mod-Analyzer/releases/latest" },
    @{ Name="SystemInformer";        Desc="Advanced process and kernel inspector";        Category="CSVY"; Type="Link";   URL="https://www.systeminformer.com/canary" },
    @{ Name="DQRKIS-FUCKER";         Desc="Detects DQRKIS cheat artefacts";              Category="CSVY"; Type="Cmd";    Command="Invoke-Expression (Invoke-RestMethod 'https://raw.githubusercontent.com/cheesecatlol/DQRKIS-FUCKER/refs/heads/main/DqrkisFucker.ps1')" },
    @{ Name="MacroDetector";         Desc="Detects macro / clicker software traces";     Category="CSVY"; Type="Cmd";    Command="Invoke-Expression (Invoke-RestMethod 'https://raw.githubusercontent.com/NiccBlahh/MacroDetector/refs/heads/main/MacroDetector.ps1')" },
    @{ Name="Everything";            Desc="Instant filename search engine for Windows";  Category="CSVY"; Type="Link";   URL="https://www.voidtools.com/downloads/" },
    @{ Name="BrowserDownloadsView";  Desc="Lists all browser download history";          Category="CSVY"; Type="Web";    URL="https://www.nirsoft.net/utils/browserdownloadsview.zip" },
    @{ Name="USBDeview";             Desc="Lists all USB devices ever connected";        Category="CSVY"; Type="Web";    URL="https://www.nirsoft.net/utils/usbdeview.zip" }
...
<Window
    ...
    <Window.Resources>
        <SolidColorBrush x:Key="Bg" Color="#070914"/>
        <SolidColorBrush x:Key="Panel" Color="#0D1020"/>
        <SolidColorBrush x:Key="Panel2" Color="#14182B"/>
        <SolidColorBrush x:Key="Line" Color="#252A45"/>
        <SolidColorBrush x:Key="Accent" Color="#7C8CFF"/>
        <SolidColorBrush x:Key="AccentSoft" Color="#182044"/>
        <SolidColorBrush x:Key="Text" Color="#F4F7FB"/>
        <SolidColorBrush x:Key="Muted" Color="#9AA3C2"/>
        <SolidColorBrush x:Key="Console" Color="#060711"/>

        <!-- Global button style: completely removes Windows yellow/default hover -->
        <Style TargetType="Button">
            <Setter Property="Background" Value="#11162A"/>
            <Setter Property="Foreground" Value="#F4F7FB"/>
            <Setter Property="BorderBrush" Value="#30385C"/>
                    ...
                    <ControlTemplate TargetType="Button">
                        ...
                        <ControlTemplate.Triggers>
                            <Trigger Property="IsMouseOver" Value="True">
                                <Setter Property="Background" Value="#252044"/>
                                <Setter Property="BorderBrush" Value="#7C8CFF"/>
                                <Setter Property="Foreground" Value="#FFFFFF"/>
                            </Trigger>
                            <Trigger Property="IsPressed" Value="True">
                                <Setter Property="Background" Value="#30305C"/>
                                <Setter Property="BorderBrush" Value="#9AA6FF"/>
                            </Trigger>
        ...
        <Style TargetType="TextBox">
            <Setter Property="SelectionBrush" Value="#7C8CFF"/>
            ...
            <Setter Property="Template">
                <Setter.Value>
                    <ControlTemplate TargetType="Button">
                        ...
                        <ControlTemplate.Triggers>
                            <Trigger Property="IsMouseOver" Value="True">
                                <Setter Property="Background" Value="#191832"/>
    ...
    <Border Background="{StaticResource Bg}" BorderBrush="#252A45" BorderThickness="1" CornerRadius="16">
        <Grid>
            <Grid.RowDefinitions>
            ...
            <!-- Top bar -->
            <Border Grid.Row="0" Background="#0B0E1B" BorderBrush="{StaticResource Line}" BorderThickness="0,0,0,1"
                ...
                <Grid Margin="20,0">
                    ...
                    <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
                        <Border Width="34" Height="34" CornerRadius="9" Background="{StaticResource AccentSoft}" Margin="0,0,11,0">
                            <TextBlock Text="C" Foreground="{StaticResource Accent}" FontSize="16" FontWeight="Bold"
                                       HorizontalAlignment="Center" VerticalAlignment="Center"/>
                        </Border>
                        <StackPanel>
                            <TextBlock Text="CSVY Toolkit" Foreground="{StaticResource Text}" FontSize="15" FontWeight="SemiBold"/>
                            <TextBlock Text="Windows utility launcher" Foreground="{StaticResource Muted}" FontSize="10" Margin="0,2,0,0"/>
                        </StackPanel>
                    </StackPanel>

                    <Border Grid.Column="1" Height="34" Margin="20,0,12,0" Background="#0F1322" BorderBrush="#34305A" BorderThickness="1" CornerRadius="10" VerticalAlignment="Center">
                        <Grid>
                            <TextBlock Text="⌕" Foreground="#7E8BCB" FontSize="16" VerticalAlignment="Center" Margin="11,0,0,0"/>
                            <TextBox x:Name="SearchBox" Text="Search tools..." Margin="32,0,8,0"
                                     Background="Transparent" BorderThickness="0" Foreground="#7D86A5"
                                     FontSize="11" VerticalContentAlignment="Center" FocusVisualStyle="{x:Null}"/>
                        </Grid>
                    </Border>

                    <StackPanel Grid.Column="2" Orientation="Horizontal" VerticalAlignment="Center">
                        <Button x:Name="MinBtn" Style="{StaticResource WindowButton}" FocusVisualStyle="{x:Null}" Content="—"/>
                        <Button x:Name="CloseBtn" Style="{StaticResource WindowButton}" FocusVisualStyle="{x:Null}" Content="×"/>
                    </StackPanel>
                </Grid>
            </Border>
            ...
            <Grid Grid.Row="1">
                ...
                <!-- Sidebar -->
                <Border Grid.Column="0" Background="#0A0D18" BorderBrush="{StaticResource Line}" BorderThickness="0,0,1,0"
                        Padding="14,18">
                    <Grid>
                        <Grid.RowDefinitions>
                            <RowDefinition Height="*"/>
                        ...
                        <StackPanel>
                            <TextBlock Text="WORKSPACE" Foreground="#737C9D" FontSize="9" FontWeight="Bold" Margin="8,0,0,10"/>
                            <Button Style="{StaticResource NavButton}" FocusVisualStyle="{x:Null}" Content="  Tool library"/>
                            <Button Style="{StaticResource NavButton}" FocusVisualStyle="{x:Null}" Content="  Activity"/>

                            <Border Height="1" Background="{StaticResource Line}" Margin="8,14,8,14"/>

                            <TextBlock Text="QUICK ACTIONS" Foreground="#737C9D" FontSize="9" FontWeight="Bold" Margin="8,0,0,10"/>
                            <Button x:Name="OpenFolderBtn" Style="{StaticResource NavButton}" FocusVisualStyle="{x:Null}" Content="  Open install folder"/>
                            <Button x:Name="OpenCmdBtn" Style="{StaticResource NavButton}" FocusVisualStyle="{x:Null}" Content="  Open CMD"/>
                            <Button x:Name="ClearCacheBtn" Style="{StaticResource NavButton}" FocusVisualStyle="{x:Null}" Content="  Clear downloaded files"/>
                        </StackPanel>

                        <StackPanel Grid.Row="1" Margin="8,0,8,4">
                            <TextBlock Text="CSVY" Foreground="{StaticResource Accent}" FontSize="11" FontWeight="Bold"/>
                            <TextBlock Text="Clean • Fast • Local" Foreground="{StaticResource Muted}" FontSize="10" Margin="0,3,0,0"/>
                            <TextBlock x:Name="InstPathBlock" Text="Install path" Foreground="#70799A" FontSize="9"
                ...
                <!-- Content -->
                <Grid Grid.Column="1" Margin="20,18,20,18">
                    <Grid.RowDefinitions>
                        <RowDefinition Height="Auto"/>
                        <RowDefinition Height="Auto"/>
                        <RowDefinition Height="*"/>
                    ...
                    <Grid Grid.Row="0">
                        <StackPanel>
                            <TextBlock Text="Tool library" Foreground="{StaticResource Text}" FontSize="24" FontWeight="SemiBold"/>
                            <TextBlock Text="Browse, download and launch your utilities." Foreground="{StaticResource Muted}"
                                       FontSize="12" Margin="0,5,0,0"/>
                        </StackPanel>
                        <Border HorizontalAlignment="Right" Background="{StaticResource Panel2}" BorderBrush="{StaticResource Line}"
                                BorderThickness="1" CornerRadius="10" Padding="11,7">
                            <StackPanel Orientation="Horizontal">
                                <Ellipse Width="7" Height="7" Fill="#5ED49A" Margin="0,0,7,0"/>
                                <TextBlock x:Name="StatusBadge" Text="IDLE" Foreground="{StaticResource Muted}" FontSize="9" FontWeight="Bold"/>
                            </StackPanel>
                        </Border>
                    </Grid>

                    <Border Grid.Row="1" Background="{StaticResource Panel}" BorderBrush="{StaticResource Line}" BorderThickness="1"
                            CornerRadius="12" Padding="14" Margin="0,14,0,11">
                        <Grid>
                            <Grid.ColumnDefinitions>
                                <ColumnDefinition Width="Auto"/>
                                <ColumnDefinition Width="*"/>
                            ...
                            <Border Width="38" Height="38" CornerRadius="10" Background="{StaticResource AccentSoft}">
                                <TextBlock Text="✓" Foreground="{StaticResource Accent}" FontSize="17"
                                           HorizontalAlignment="Center" VerticalAlignment="Center"/>
                            </Border>
                            <StackPanel Grid.Column="1" Margin="12,0,0,0" VerticalAlignment="Center">
                                <TextBlock x:Name="StatusTitle" Text="Ready" Foreground="{StaticResource Text}" FontSize="12" FontWeight="SemiBold"/>
                                <TextBlock x:Name="StatusSub" Text="Select a tool to launch or download it." Foreground="{StaticResource Muted}"
                                           FontSize="10" Margin="0,2,0,0"/>
                            </StackPanel>
                            <TextBlock Grid.Column="2" x:Name="CatBlock" Text="CSVY" Foreground="{StaticResource Accent}"
                    ...
                    <Border Grid.Row="2" Background="{StaticResource Panel}" BorderBrush="{StaticResource Line}" BorderThickness="1"
                        ...
                        <TabControl x:Name="ToolsTab" Background="Transparent" BorderThickness="0" Foreground="{StaticResource Text}">
                    ...
                    <Border Grid.Row="3" Background="{StaticResource Console}" BorderBrush="{StaticResource Line}" BorderThickness="1"
                            CornerRadius="12" Margin="0,10,0,0" Padding="14">
                        <Grid>
                            <Grid.RowDefinitions>
                                <RowDefinition Height="Auto"/>
                                <RowDefinition Height="*"/>
                            ...
                            <TextBlock Text="ACTIVITY" Foreground="#737C9D" FontSize="9" FontWeight="Bold"/>
                            <TextBlock Grid.Column="1" Text="LIVE" Foreground="{StaticResource Accent}" FontSize="9" FontWeight="Bold"/>
                            <TextBox x:Name="LogBox" Grid.Row="1" Grid.ColumnSpan="2"
                                     Background="Transparent" Foreground="#BFC7EA" BorderThickness="0"
                                     FontFamily="Consolas" FontSize="10" IsReadOnly="True"
                                     VerticalScrollBarVisibility="Auto" TextWrapping="Wrap" Margin="0,8,0,0"/>
                        </Grid>
                    </Border>
                </Grid>
            </Grid>
...
<Window
    ...
    Background="Transparent"
    FontFamily="Segoe UI">
    <Border Background="#0B0D12" BorderBrush="#252A45" BorderThickness="1" CornerRadius="16" Padding="30">
        <Grid>
            <Grid.RowDefinitions>
                <RowDefinition Height="*"/>
            ...
            <StackPanel>
                <Border Width="46" Height="46" CornerRadius="12" Background="#182044" HorizontalAlignment="Left" Margin="0,0,0,18">
                    <TextBlock Text="C" Foreground="#7C8CFF" FontSize="21" FontWeight="Bold"
                               HorizontalAlignment="Center" VerticalAlignment="Center"/>
                </Border>
                <TextBlock Text="CSVY Toolkit" FontSize="25" FontWeight="SemiBold" Foreground="#F4F7FB"/>
                <TextBlock Text="Before you continue" FontSize="12" Foreground="#8D98AA" Margin="0,5,0,24"/>
                <TextBlock TextWrapping="Wrap" Foreground="#D0D5EA" FontSize="12" LineHeight="20"
                           Text="Tools are downloaded from their listed repositories and stored locally in the CSVY Toolkit folder. The toolkit itself does not collect or modify your personal information."/>
                <TextBlock TextWrapping="Wrap" Foreground="#D0D5EA" FontSize="12" LineHeight="20" Margin="0,10,0,0"
                           Text="Third-party tools are maintained by their respective authors. Review and use those tools according to your own requirements."/>
                <Border Background="#0F1322" BorderBrush="#252A45" BorderThickness="1" CornerRadius="10" Padding="12" Margin="0,20,0,0">
                    <TextBlock TextWrapping="Wrap" Foreground="#8D98AA" FontSize="11"
                               Text="Continuing means you acknowledge the information above."/>
                </Border>
            </StackPanel>
            <Grid Grid.Row="1" VerticalAlignment="Bottom">
                ...
                <Button x:Name="CancelBtn" Grid.Column="0" Content="Cancel" Height="42"
                        Background="Transparent" Foreground="#B5BEDA" BorderBrush="#252A45" BorderThickness="1"
                        Cursor="Hand" FontSize="12" FocusVisualStyle="{x:Null}"/>
                <Button x:Name="AcceptBtn" Grid.Column="2" Content="Continue" Height="42"
                        Background="#182044" Foreground="#7C8CFF" BorderBrush="#7C8CFF" BorderThickness="1"
...
function Start-CmdToolCommand {
    ...
    $tempScript = [System.IO.Path]::Combine($env:TEMP, "csvy_$([guid]::NewGuid().ToString('N')).ps1")
    ...
    $startArgs = '/c start "CSVY Toolkit" powershell.exe -NoExit -NoProfile -ExecutionPolicy Bypass -File "' + $tempScript + '"'
...
function Save-UrlToFile {
    ...
    $client.Headers.Add("User-Agent", "CSVY Toolkit")
    try {
...
function Get-GitHubAssetUrl {
    ...
    if ($ReleaseUrl -match "github\.com/([^/]+)/([^/]+)/releases/tag/(.+)$") {
        ...
        try {
            $rel   = Invoke-RestMethod -Uri $api -Headers @{"User-Agent"="CSVY Toolkit"} -ErrorAction Stop
...
function Start-ButtonAnimation {
    ...
    # Flash sequence: galaxy indigo pulse -> restore
    $flashColors = @("#6678FF", "#B9C2FF", "#6678FF", "#7C8CFF")
    $flashFg     = "#0A0715"
...
$Categories = @("CSVY","Orbdiff","Spokwn","Tonynoh","Praiselily","RedLotus","Zimmerman","NirSoft","Dependencies","Others")
...
foreach ($cat in $Categories) {
    ...
    foreach ($tool in $catTools) {
        ...
        $btn.Tag = $t
        [void]$script:ToolButtons.Add($btn)

        switch ($t.Type) {
            "Cmd"    { $btn.Background = "#11152A" }
            "GitHub" { $btn.Background = "#11152A" }
            "Web"    { $btn.Background = "#11152A" }
            "Link"   { $btn.Background = "#11152A" }
        }

        # Create animatable (unfrozen) objects in PowerShell code
        $btnBg    = [Windows.Media.SolidColorBrush]::new([Windows.Media.Color]::FromRgb(0x17, 0x14, 0x2A))
        $btnScale = [Windows.Media.ScaleTransform]::new(1.0, 1.0)
        $btnGlow  = [Windows.Media.Effects.DropShadowEffect]::new()
        $btnGlow.Color       = [Windows.Media.Color]::FromRgb(0x7C, 0x8C, 0xFF)
        ...
        $btn.Add_MouseLeave({
            ...
            $b.Foreground = [Windows.Media.BrushConverter]::new().ConvertFrom("#F1EEFF")
        })
        ...
        $btn.Add_Click({
            ...
            $script:timer.Add_Tick({
                ...
                $script:timerBtn.Foreground = [Windows.Media.BrushConverter]::new().ConvertFrom("#F1EEFF")
                ...
                $null = $ps.AddScript({
                    ...
                    try {
                        ...
                        if ($type -eq "GitHub") {
                            ...
                            $headers  = @{ "User-Agent" = "CSVY Toolkit" }
...
if ($SearchBox) {
    $SearchBox.Add_GotFocus({
        if ($SearchBox.Text -eq "Search tools...") {
            $SearchBox.Text = ""
            $SearchBox.Foreground = [Windows.Media.Brushes]::White
        }
    })
    $SearchBox.Add_LostFocus({
        if ([string]::IsNullOrWhiteSpace($SearchBox.Text)) {
            $SearchBox.Text = "Search tools..."
            $SearchBox.Foreground = [Windows.Media.Brushes]::Gray
        }
    })
    $SearchBox.Add_TextChanged({
        $query = $SearchBox.Text.Trim().ToLowerInvariant()
        if ($query -eq "search tools...") { $query = "" }
        foreach ($button in $script:ToolButtons) {
            $name = [string]$button.ToolTip
            $button.Visibility = if ([string]::IsNullOrWhiteSpace($query) -or $name.ToLowerInvariant().Contains($query)) {
